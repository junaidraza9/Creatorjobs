...
<?php include_once("header.php");?>
    ...
    <center> 
<h2 style="color:#741349">Register Your Account
</h2>
 <hr
...
style="width: 60px; background-color: #102693; height: 2px">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
          <form action="register-core.php" method="Post">
             ...
             <!-- <div class="form-group">
                ...
                <input type="text"class="form-control" name="phone" id="email" aria-describedby="helpId" placeholder="" required pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}{+}"> 
              </div>-->

              <div class="form-group">
                <label for="">Looking For *</label>
<select name="Lookingfor" id="tt" class="form-control" required>
<!--<option value="1">I want to hire</option>-->
    <option value="0">I want a job</option>
...
<script>
 ...
 var y =  document.getElementById("experince");
...
y.style.display="block";
  ...
  y.style.display="none";
          ...
          <div class="form-group " id="experince" >
                <label for="">specialize in</label>
<select name="specialize" id="" class="form-control">
    ...
    <option value="YouTube Producer">YouTube Producer</option>
        ...
        <!--  <div class="form-group">
          ...
          <div class="form-group">
                ...
                <input type="text"class="form-control" name="pwd" id="pwd" aria-describedby="helpId" placeholder="" required> 
              </div>    
              <div class="form-group">
                <label for="">Confirm Password *</label>
                <input type="text"class="form-control" name="cpwd" id="cpwd" aria-describedby="helpId" placeholder="" required> 
              </div>
 ...
 <center>
       <input type="submit"class="form-control bg-danger" name="sub" id="sub" value="Register Now" style="width:70%;color:white">
 </center>
    </form>   
    <br>
    <p class="text-danger text-center"> Have an account?  <a href="login.php" class="text-dark">Login.</a></p>
    </div>
<br>
    <?php
...
<script>
  swal({
  title: "Warning!",
  text: "your password should be at lest 8 charter !",
...
<script>
  swal({
  title: "Warning!",
  text: "this email is allready use!",
  icon: "warning", //note you can write here error or warning or info 
  button: "ok",
});
</script>
...
if(isset($_REQUEST["password-error"])){
...
<script>
  ...
  text: "your password and confirm password is not match!",
  icon: "info", //note you can write here error or warning or info 
  button: "ok",
});
</script>
