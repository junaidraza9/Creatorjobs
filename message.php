...
$selectQuery = "SELECT * FROM `message` WHERE `user_id`='$id'  OR `reciver_id`='$id' ORDER BY `id` DESC";
...
while ($alldata = mysqli_fetch_array($runQ )) {
  ...
  $reciver_avatar= $alldata["reciver_avatar"];
  $reciver_name= $alldata["reciver_name"];
